-- =============================================================================
-- SICOF — Datos Iniciales / Seed (PostgreSQL)
-- ON CONFLICT DO NOTHING garantiza idempotencia: re-ejecutar es seguro.
...
-- ── Conductores — Terminal 1: El Roble ───────────────────────────────────────
...
ON CONFLICT (codigo_recorrido) DO NOTHING;

-- ── Usuarios del sistema ──────────────────────────────────────────────────────
-- Contraseña por defecto: "sicof2026" (hash SHA256 simulado — usar bcrypt en producción)
...
-- ── Asignaciones activas (turno AM) ──────────────────────────────────────────
INSERT INTO asignacion (id_bus, id_conductor, id_terminal, id_ruta, fecha_hora_inicio) VALUES
    (1, 1, 1, 1, '2026-05-24T05:30:00+00:00'),  -- EB-214 / Carla Pizarro / 406
    (2, 2, 1, 2, '2026-05-24T05:30:00+00:00'),  -- EB-301 / Juan Rojas / 405c
    (6, 3, 1, 3, '2026-05-24T05:30:00+00:00'),  -- D-226  / Andrea Peña / 418
    (7, 4, 1, 5, '2026-05-24T05:30:00+00:00'),  -- D-118  / Mauricio Lagos / B12
    (3, 5, 1, 6, '2026-05-24T05:30:00+00:00'),  -- EB-455 / Daniel Soto / B20
    (8, 6, 1, 3, '2026-05-24T09:30:00+00:00')   -- D-287  / Nicole Salas / 418 (relevo)
...
INSERT INTO estado_carga (id_bus, nivel_carga, autonomia_km, timestamp) VALUES
    (1, 92.0, 180.0, '2026-05-24T05:20:00+00:00'),  -- EB-214: carga alta
    (2, 41.0,  78.0, '2026-05-24T05:20:00+00:00'),  -- EB-301: bajo umbral
    (3, 77.0, 148.0, '2026-05-24T05:20:00+00:00'),  -- EB-455: carga suficiente
    (4, 58.0, 110.0, '2026-05-24T05:20:00+00:00'),  -- EB-118: cargando
    (5, 35.0,  65.0, '2026-05-24T05:20:00+00:00')   -- EB-212: crítico
ON CONFLICT DO NOTHING;

-- ── Posiciones GPS simuladas ──────────────────────────────────────────────────
INSERT INTO registro_gps (id_bus, coordenada_lat, coordenada_lon, velocidad_kmh, timestamp) VALUES
    (1, -33.3585, -70.7345,  0.0, '2026-05-24T05:40:00+00:00'),  -- EB-214 en patio
    (1, -33.3620, -70.7310, 28.5, '2026-05-24T05:42:00+00:00'),  -- EB-214 saliendo
    (2, -33.3578, -70.7342,  0.0, '2026-05-24T05:40:00+00:00'),  -- EB-301 en patio
    (6, -33.3582, -70.7338,  0.0, '2026-05-24T05:45:00+00:00'),  -- D-226 en posición
    (7, -33.3575, -70.7350,  0.0, '2026-05-24T05:40:00+00:00')   -- D-118 en patio
ON CONFLICT DO NOTHING;
...
INSERT INTO incidente (id_bus, id_conductor, tipo, severidad, descripcion, coordenada_lat, coordenada_lon, estado, fecha_hora) VALUES
    (2, 2, 'Energía',       'Alta',  'SoC insuficiente para vuelta completa en servicio 405c. Requiere swap o reasignación.',          -33.3580, -70.7340, 'Escalado', '2026-05-24T05:35:00+00:00'),
    (7, 4, 'Mantenimiento', 'Media', 'Sensor de puerta reporta intermitencia. No bloquea reserva pero requiere revisión.',             -33.3575, -70.7350, 'Abierto',  '2026-05-24T05:50:00+00:00'),
    (1, 1, 'Vial',          'Media', 'Congestión en acceso Alameda. Se mantiene ruta con desvío sugerido, tiempo de paso controlado.', -33.4420, -70.6530, 'Abierto',  '2026-05-24T06:05:00+00:00')
ON CONFLICT DO NOTHING;
...
INSERT INTO rol_permiso (rol, id_permiso) VALUES
    ...
    ('Admin TI', 4),
    ('Admin TI', 5)
ON CONFLICT (rol, id_permiso) DO NOTHING;

-- ── Auditoría Inicial ─────────────────────────────────────────────────────────
INSERT INTO auditoria (username, accion, tabla_afectada, registro_id, detalles, fecha_hora) VALUES
    ('admin',    'LOGIN',  'usuario',         6, 'Inicio de sesión exitoso desde terminal TI',              '2026-06-01T10:15:30+00:00'),
    ('admin',    'UPDATE', 'parametro_global', 1, 'Cambio de umbral_soc_critico de 25 a 30',               '2026-06-01T10:18:12+00:00'),
    ('cpizarro', 'CREATE', 'asignacion',       1, 'Creación de asignación para bus EB-214 y cond Carla Pizarro', '2026-06-01T11:02:44+00:00'),
    ('admin',    'UPDATE', 'usuario',          4, 'Habilitación de rol Admin COF para Paula Vera',          '2026-06-01T12:00:05+00:00')
ON CONFLICT DO NOTHING;

-- ── Reportes/Descargas ────────────────────────────────────────────────────────
INSERT INTO reporte_descarga (nombre, tipo, fecha_creacion, url_archivo, creador) VALUES
    ('Reporte_Consumo_Mayo_2026.pdf',    'Consumo Energético',   '2026-05-31T23:59:00+00:00', '/downloads/reportes/Reporte_Consumo_Mayo_2026.pdf',    'pvera'),
    ('Kpis_Frecuencia_Semana22.xlsx',   'Frecuencia y Regulación', '2026-06-01T08:00:00+00:00', '/downloads/reportes/Kpis_Frecuencia_Semana22.xlsx', 'pvera'),
    ('Historico_Incidentes_ElRoble.pdf', 'Incidentes y Fallas', '2026-06-01T09:30:00+00:00', '/downloads/reportes/Historico_Incidentes_ElRoble.pdf', 'pvera')
ON CONFLICT DO NOTHING;
